...
class _ClienteFormPageState extends State<ClienteFormPage> {
      ...
      onWillPop: () async {
        ...
        _isViewPage
            ? Navigator.of(context)
                .pushNamedAndRemoveUntil('/clientes', (route) => false)
            : await showDialog(
                context: context,
                builder: (context) {
  ...
  Future<void> _populateController(Cliente cliente) async {
    setState(() {
      ...
      _controllers.rg!.text = cliente.rg ?? '';
      _controllers.email!.text = cliente.email ?? '';
      _controllers.cep!.text = cliente.cep ?? '';
      _controllers.paisId!.text = cliente.paisId ?? '';
      _controllers.paisNomePais!.text = cliente.paisNomePais ?? '';
      ...
      _controllers.numero!.text = (cliente.numero ?? '').toString();
      _controllers.complemento!.text = cliente.complemento ?? '';
      _controllers.telefone!.text = cliente.telefone ?? '';
      _controllers.observacoes!.text = cliente.observacoes ?? '';
