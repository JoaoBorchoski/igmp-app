...
import 'package:igmp/presentation/ui/operacao/medi%C3%A7%C3%A3o/list/medi%C3%A7%C3%A3o_list_widget.dart';
...
class MedicaoListPage extends StatefulWidget {
  const MedicaoListPage({Key? key}) : super(key: key);

  @override
  State<MedicaoListPage> createState() => _MedicaoListPageState();
}

class _MedicaoListPageState extends State<MedicaoListPage> {
  String _query = '';
  late int _page;
  ...
  void _hasErrorDialog() async {
    await showDialog(
        ...
        builder: (context) => ConfirmActionWidget(
            message: 'Ocorreu um erro ao carregar as medicoes.',
                  ...
                  child: _cards.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (index == _cards.length - _nextPageTrigger &&
                                !_isLastPage) {
                              _fetchData();
                            }
                            ...
                            final Medicao card = _cards[index];
                            return MedicaoListWidget(card);
                          },
                        ),
                ),
              ),
